...
const diia = () => {
  ...
  return ({
    ...
    keywords: {
      ...
      keyword: "дія рівно більше менше пак спробувати не впасти тривала зловити є перебрати вернути кінець структура чекати взяти якщо або і інакше поки як дати модуль",
