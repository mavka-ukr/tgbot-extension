...
context.set("бот_апі_отримати_список_оновлень", mavka.tools.asyncFn(async ([token, lastUpdateId]) => {
...
context.set("надіслати_повідомлення", mavka.tools.asyncFn(async ([token, message]) => {
